<script>
    import {loadIcons} from './IconManager.js'
...
<svg viewBox="0 0 48 48" id="audio">
    <path fill="#35c1f1" d="M24,44c-0.553,0-1-0.447-1-1V5c0-0.553,0.447-1,1-1s1,0.447,1,1v38C25,43.553,24.553,44,24,44z"/>
    <path fill="#195bbc" d="M28,32c-0.553,0-1-0.447-1-1V19c0-0.553,0.447-1,1-1s1,0.447,1,1v12C29,31.553,28.553,32,28,32z"/>
    <path fill="#195bbc" d="M32,32c-0.553,0-1-0.447-1-1V9c0-0.553,0.447-1,1-1s1,0.447,1,1v22C33,31.553,32.553,32,32,32z"/>
    <path fill="#195bbc" d="M36,32c-0.553,0-1-0.447-1-1V19c0-0.553,0.447-1,1-1s1,0.447,1,1v12C37,31.553,36.553,32,36,32z"/>
    <path fill="#195bbc" d="M40,32c-0.553,0-1-0.447-1-1v-6c0-0.553,0.447-1,1-1s1,0.447,1,1v6C41,31.553,40.553,32,40,32z"/>
    <path fill="#195bbc" d="M44,32c-0.553,0-1-0.447-1-1V17c0-0.553,0.447-1,1-1s1,0.447,1,1v14C45,31.553,44.553,32,44,32z"/>
    <path fill="#195bbc" d="M4,32c-0.553,0-1-0.447-1-1v-6c0-0.553,0.447-1,1-1s1,0.447,1,1v6C5,31.553,4.553,32,4,32z"/>
    <path fill="#195bbc" d="M8,32c-0.553,0-1-0.447-1-1V17c0-0.553,0.447-1,1-1s1,0.447,1,1v14C9,31.553,8.553,32,8,32z"/>
    <path fill="#195bbc" d="M12,32c-0.553,0-1-0.447-1-1v-9c0-0.553,0.447-1,1-1s1,0.447,1,1v9C13,31.553,12.553,32,12,32z"/>
    <path fill="#195bbc" d="M16,32c-0.553,0-1-0.447-1-1V13c0-0.553,0.447-1,1-1s1,0.447,1,1v18C17,31.553,16.553,32,16,32z"/>
    <path fill="#195bbc" d="M20,32c-0.553,0-1-0.447-1-1V19c0-0.553,0.447-1,1-1s1,0.447,1,1v12C21,31.553,20.553,32,20,32z"/>
</svg>

<svg viewBox="0 0 48 48" id="clear">
    <linearGradient id="vJFnnELBWK5228o12uLXWa" x1="18.053" x2="36.065" y1="7.681" y2="41.558" gradientUnits="userSpaceOnUse">
        <stop offset="0" stop-color="#f44f5a"/>
        <stop offset=".443" stop-color="#ee3d4a"/>
        <stop offset="1" stop-color="#e52030"/>
    </linearGradient>
    <path fill="url(#vJFnnELBWK5228o12uLXWa)" d="M46,36H10.448c-0.585,0-1.141-0.246-1.521-0.673L0.188,24.591c-0.28-0.344-0.28-0.838,0-1.182	l8.738-10.736C9.307,12.246,9.862,12,10.448,12H46c1.105,0,2,0.859,2,1.92v20.16C48,35.141,47.104,36,46,36z"/>
    <path d="M32.074,32c-0.479,0-0.931-0.187-1.271-0.527L27,27.669l-3.804,3.804	C22.855,31.813,22.404,32,21.925,32c-0.481,0-0.933-0.188-1.272-0.528l-1.126-1.126c-0.701-0.702-0.7-1.842,0-2.542L23.331,24	l-3.805-3.804C19.187,19.856,19,19.405,19,18.925c0-0.48,0.187-0.932,0.526-1.271l1.128-1.127c0.34-0.34,0.791-0.527,1.271-0.527	c0.48,0,0.932,0.187,1.271,0.527L27,20.331l3.804-3.804c0.34-0.34,0.791-0.527,1.271-0.527c0.479,0,0.931,0.187,1.271,0.527	l1.127,1.127C34.813,17.993,35,18.445,35,18.926c0,0.48-0.188,0.932-0.529,1.271L30.669,24l3.804,3.804	c0.34,0.338,0.527,0.79,0.527,1.271c0,0.48-0.188,0.933-0.529,1.272l-1.125,1.125C33.005,31.813,32.554,32,32.074,32z" opacity=".05"/>
    <path d="M32.074,31.5c-0.347,0-0.672-0.135-0.917-0.38L27,26.962l-4.157,4.158	c-0.246,0.246-0.572,0.38-0.918,0.38c-0.348,0-0.673-0.135-0.918-0.381l-1.127-1.126c-0.506-0.507-0.506-1.33,0-1.835L24.038,24	l-4.158-4.158c-0.245-0.245-0.38-0.571-0.38-0.917s0.135-0.672,0.38-0.917l1.128-1.127c0.245-0.245,0.57-0.38,0.917-0.38	c0.348,0,0.673,0.135,0.918,0.38L27,21.038l4.157-4.158c0.245-0.245,0.57-0.38,0.918-0.38c0.347,0,0.672,0.135,0.917,0.38	l1.127,1.127c0.246,0.245,0.381,0.572,0.381,0.918s-0.136,0.672-0.382,0.917L29.962,24l4.157,4.158	c0.245,0.244,0.381,0.57,0.381,0.917c0,0.347-0.136,0.673-0.382,0.918l-1.126,1.126C32.746,31.365,32.421,31.5,32.074,31.5z" opacity=".07"/>
...
<svg viewBox="0 0 48 48" id="crop">
    <g transform="matrix(1,0,0,1,-3,0)">
        ...
        <g transform="matrix(-1,-0.000159867,0.000159867,-1,67.9994,48.0053)">
...
<svg viewBox="0 0 48 48" id="envelope">
    <g>
        <path d="M5,5C5,5 24,5 25,24C26,43 43,43 43,43L5,43L5,5Z" style="stroke:black;stroke-width:2px;"/>
    </g>
</svg>

<svg viewBox="0 0 48 48" id="time-stretch">
    <g transform="matrix(1,0,0,1,-3,0)">
        <g transform="matrix(0.974359,0,0,0.95,4.10256,1.2)">
            <ellipse cx="23.5" cy="24" rx="19.5" ry="20" style="fill-opacity:0;stroke:black;stroke-width:5px;"/>
        </g>
        <g transform="matrix(0.875,0,0,1,6,0)">
            <path d="M8,24L40,24L36,20" style="fill:none;stroke:black;stroke-width:3px;"/>
        </g>
        <g transform="matrix(1,0,0,1,5,0)">
            <path d="M12,20L8,24L12,28" style="fill:none;stroke:black;stroke-width:3px;"/>
        </g>
        <g transform="matrix(1,0,0,1,1,0)">
            <path d="M40,24L36,28" style="fill:none;stroke:black;stroke-width:3px;"/>
        </g>
    </g>
</svg>

<svg viewBox="0 0 48 48" id="wand">
