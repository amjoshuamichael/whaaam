<script>
	import {getBuffer} from '../Audio/LoadedSounds'
	import {onMount} from 'svelte'
	import {lengthInSamples} from '../Audio/Generate'
	import makeDraggable from '../UtilGUI/DragAndDrop'
	import {singleClick} from '../UtilGUI/ClickFunctions'
	import genWavePath from '../UtilGUI/Waveform'
	import {getNew, getLast} from '../Utilities/UUID'
	import {assign, unassign} from '../UtilGUI/Shortcuts'
	import {removeSamp, alterGenParameter} from '../Audio/SampList'

	import Modal from '../UtilComponents/Modal.svelte'
	import EffectsMenu from "../SampMenu/EffectsMenu.svelte";
...
{#if isMenuOpened}
	<Modal onClose={closeMenu}>
		<EffectsMenu data={data} sampIndex={sampIndex}/>
	</Modal>
{/if}
