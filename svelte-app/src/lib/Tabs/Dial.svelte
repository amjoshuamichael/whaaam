...
<style>
	...
	@keyframes mymove {
		...
		to {transform: translate(170px, 0px);}
	}
</style>
...
<div class="dial">
	<svg viewBox="0 0 48 48">
		...
		<defs>
			<radialGradient id="_Radial1" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="matrix(10.654,0,0,-10.654,32,14)"><stop offset="0" style="stop-color:rgb(158,23,194);stop-opacity:1"/><stop offset="0.16" style="stop-color:rgb(166,29,200);stop-opacity:1"/><stop offset="0.38" style="stop-color:rgb(183,44,212);stop-opacity:1"/><stop offset="1" style="stop-color:rgb(231,86,247);stop-opacity:1"/></radialGradient>
		</defs>
	</svg>
	<input type=range bind:value={params[value]} on:input={onchange} min={min} max={max} step=1>
</div>
